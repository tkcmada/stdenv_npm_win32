...
<body>
  <h1>Examples</h1>
  <p>This repo has significantly expanded the set of Examples from the mleibman repo</p>
  <h2>Basic Use</h2>
  <div>
    <ul>
  ...
  <div>
    <ul>
      <li><a href="example-multi-grid-basic.html">Putting multiple grids on a page</a></li>
      <li><a href="example-bootstrap-3-header.html">With Bootstrap 3 header</a></li>
      <li><a href="example-jquery-accordion.html">SlickGrid inside jQuery Accordion</a></li>
      <li><a href="example-dynamic-with-jquery-tabs.html">Dynamically created SlickGrid inside jQuery tabs</a></li>
      <li><a href="example-dynamic-filtered-with-jquery-tabs.html">Dynamically created SlickGrid with DataView and filtering, inside jQuery tabs</a></li>
      <li><a href="example-autocomplete-editor.html">jQuery Autocomplete editor</a></li>
      <li><a href="example-select2-editor.html">Select2 javascript drop-down editor</a></li>
    </ul>
  </div>
  <h2>Plugins</h2>
  <div>
